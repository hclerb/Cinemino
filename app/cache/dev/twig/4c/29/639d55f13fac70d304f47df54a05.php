...
/* CineminoSiteBundle:ProgrammeCourts:edit.html.twig */
class __TwigTemplate_4c29639d55f13fac70d304f47df54a05 extends Twig_Template
{
    ...
    {
        // line 1
        echo "<h1>ProgrammeCourts edit</h1>

<form action=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("programmecourts_update", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "CineminoSiteBundle:ProgrammeCourts:edit.html.twig";
    }
