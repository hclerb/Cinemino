...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/Resources');
    ...
    /**
     * Gets the 'cinemino_site.allocine' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Cinemino\SiteBundle\Service\AlloHelper A Cinemino\SiteBundle\Service\AlloHelper instance.
     */
    protected function getCineminoSite_AllocineService()
    {
        return $this->services['cinemino_site.allocine'] = new \Cinemino\SiteBundle\Service\AlloHelper();
    }

    /**
     * Gets the 'cinemino_site.resizeimg' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Cinemino\SiteBundle\Service\ResizeImg A Cinemino\SiteBundle\Service\ResizeImg instance.
     */
    protected function getCineminoSite_ResizeimgService()
    {
        return $this->services['cinemino_site.resizeimg'] = new \Cinemino\SiteBundle\Service\ResizeImg();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'cinemino', 'host' => 'localhost', 'port' => 8889, 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, $c, array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager517408f6c113b_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager517408f6c113b_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/jms_diextra/doctrine/EntityManager_517408f6c113b.php';

        $a = $this->get('annotation_reader');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_ccb2278142c55b71fae94d418e19629f');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_ccb2278142c55b71fae94d418e19629f');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_ccb2278142c55b71fae94d418e19629f');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/src/Cinemino/SiteBundle/Entity', 1 => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/src/Cinemino/userBundle/Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/vendor/bundles/FOS/UserBundle/Resources/config/doctrine' => 'FOS\\UserBundle\\Entity'));
        $f->setGlobalBasename('mapping');

        $g = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $g->addDriver($e, 'Cinemino\\SiteBundle\\Entity');
        $g->addDriver($e, 'Cinemino\\UserBundle\\Entity');
        $g->addDriver($f, 'FOS\\UserBundle\\Entity');

        $h = new \Doctrine\ORM\Configuration();
        $h->setEntityNamespaces(array('CineminoSiteBundle' => 'Cinemino\\SiteBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'CineminoUserBundle' => 'Cinemino\\UserBundle\\Entity'));
        $h->setMetadataCacheImpl($b);
        $h->setQueryCacheImpl($c);
        $h->setResultCacheImpl($d);
        $h->setMetadataDriverImpl($g);
        $h->setProxyDir('/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager517408f6c113b_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($i, $this);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/Resources');
    }
    ...
    /**
     * Gets the 'form.type.cinema' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Cinemino\SiteBundle\Form\CinemaType A Cinemino\SiteBundle\Form\CinemaType instance.
     */
    protected function getForm_Type_CinemaService()
    {
        return $this->services['form.type.cinema'] = new \Cinemino\SiteBundle\Form\CinemaType($this->get('security.context'));
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Cinemino\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Cinemino\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Cinemino\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Cinemino\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Cinemino\\UserBundle\\Entity\\User');
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context'), $this->get('monolog.logger.router'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_LoginService()
    {
        ...
        return $this->services['security.firewall.map.context.login'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_manager')), 'login', $b, $this->get('event_dispatcher')), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '517408f6a45c8', $b), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'login', NULL, NULL, NULL, $b));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b), 'main', $c, $d), 2 => $i, 3 => $k, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $h, $g, $c, $d), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, '/login', false), NULL, NULL, $c));
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_PROGRAMMATEUR'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_PROGRAMMATEUR', 1 => 'ROLE_ADMIN', 2 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/translations', 'debug' => true));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
     ...
     *
     * @return EntityManager517408f6c113b_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/assetic/assets');
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/jms_security/expressions');
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml', 1 => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/vendor/bundles/FOS/UserBundle/Resources/config/validation.xml', 2 => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/vendor/bundles/FOS/UserBundle/Resources/config/validation/orm.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev',
            'kernel.logs_dir' => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/logs',
            'kernel.bundles' => array(
                ...
                'CineminoSiteBundle' => 'Cinemino\\SiteBundle\\CineminoSiteBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'CineminoUserBundle' => 'Cinemino\\UserBundle\\CineminoUserBundle',
            ...
            'debug.container.dump' => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
                1 => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/vendor/bundles/FOS/UserBundle/Resources/config/validation.xml',
                2 => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/vendor/bundles/FOS/UserBundle/Resources/config/validation/orm.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/profiler',
            ...
            'router.resource' => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/../web',
            'assetic.write_to' => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/jms_diextra/doctrine/EntityManager_517408f6c113b.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager517408f6c113b_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/Users/hcle/Documents/Hervé/SiteParnal22/Cinemino/app/cache/dev/jms_security',
            ...
            'fos_user.model.user.class' => 'Cinemino\\UserBundle\\Entity\\User',
